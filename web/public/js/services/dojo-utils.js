...
angular.module('cpZenPlatform').factory('dojoUtils', function($location, $localStorage, $translate, $state, $rootScope, cdDojoService, cdUsersService, auth, usSpinnerService, alertService){
  var dojoUtils = {};
